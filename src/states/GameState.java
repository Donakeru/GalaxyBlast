...
/*
 *Esta clase gestion la lógica del juego incluyendo, acciones del jugaor, comportamiento de los enemigos
 *puntuación y demás, de está manea se reconoce como el controlador principal,
 * 
 */
public class GameState extends State{
	...
	public GameState()
	{
		...
		meteors = 1;
		startWave();
		wave = new Sound(Assets.wave);
		wave.loop();
		wave.changeVolume(-10.0f);
